...
namespace AlexaController.Alexa.Presentation.DirectiveBuilders
{
    ...
    public class RenderAudioManager : Ssml
    {
        public static RenderAudioManager Instance { get; private set; }
        
        public RenderAudioManager()
        {
            Instance = this;
        }
        ...
        private string GetSpeechPhrase(InternalRenderAudioQuery query)
        {
            ...
            switch (query.speechContent)
            {
                ...
                case SpeechContent.BROWSE_ITEMS_BY_ACTOR:
                    ...
                    return speech.ToString();
                default:
                    throw new ArgumentOutOfRangeException(nameof(RenderAudioManager), query.speechContent, null);
            }
        }
